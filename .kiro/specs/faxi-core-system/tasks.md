...
- [ ] 6. Build MCP Controller Agent
- [ ] 6.1 Set up agent orchestration framework
...
- [ ] 6.2 Implement agent decision framework
...
- [ ] 6.3 Implement agent state management
...
- [ ] 7.6 Implement spam filtering for incoming emails
...
- [ ] 7.7 Implement smart reply generation for emails
...
- [ ] 8. Implement Shopping MCP Server
...
- [ ] 8.2 Implement search_products tool
...
- [ ] 8.6 Implement proactive shopping tools
...
- [ ] 9. Implement Payment MCP Server
...
- [ ] 9.2 Implement payment method management tools
...
- [ ] 9.5 Implement check_payment_status tool
  - Query payment status by transaction ID
  - Return payment confirmation details
  - _Requirements: 5.5_

- [ ] 9.6 Implement Stripe webhook handler
...
- [ ] 10.3 Implement conversation management tools
...
- [ ] 11. Implement User Profile MCP Server
- [ ] 11.1 Create MCP server structure
  - Set up MCP server with tool registration
  - Implement user data access controls
  - Design for modularity to support future MCP server additions
  - _Requirements: 8.1_

- [ ] 11.2 Implement profile management tools
...
- [ ] 11.3 Implement address book management tools
...
- [ ] 11.4 Implement order management tools
...
- [ ] 12. Build Response Generator
- [ ] 12.1 Create fax template system
...
- [ ] 12.2 Implement TIFF generation
...
- [ ] 12.3 Implement email fax generation
...
- [ ] 12.4 Implement product selection form generation
...
- [ ] 12.5 Implement payment barcode fax generation
...
- [ ] 12.6 Implement confirmation fax generation
...
- [ ] 12.7 Implement clarification request generation
...
- [ ] 13. Implement Fax Sender
- [ ] 13.1 Create Telnyx fax sending integration
...
- [ ] 13.3 Implement delivery status tracking
...
- [ ] 14. Implement Email-to-Fax Bridge
- [ ] 14.1 Configure email MX records
  - Set up MX records for me.faxi.jp domain
  - Configure email service to receive emails
  - _Requirements: 8.1, 8.2_

- [ ] 14.2 Create email webhook receiver
...
- [ ] 14.3 Implement email-to-fax conversion
...
- [ ] 15. Build Fax Processor Worker
- [ ] 15.1 Create job queue worker
  - Implement worker process to consume fax processing jobs
  - Handle job failures with retry logic
  - Implement graceful shutdown
  - _Requirements: 1.3_

- [ ] 15.2 Implement processing pipeline orchestration
...
- [ ] 16. Implement logging and audit system
- [ ] 16.1 Create structured logging
...
- [ ] 17. Implement welcome fax generation
- [ ] 17.1 Create welcome and onboarding fax template
...
- [ ] 17.2 Implement welcome fax sending logic
...
- [ ] 4.9 Create basic test harness
  - Implement POST /test/fax/receive endpoint for testing without Telnyx
  - Accept fax image uploads and simulate webhook processing
  - Generate mock fax metadata and enqueue processing jobs
  - Return processing status and results for debugging
  - _Requirements: All_

- [ ] 18. Create test harness for Telnyx-free testing
- [ ] 18.1 Create test webhook endpoint
...
- [ ] 18.2 Create test UI for fax simulation
...
- [ ] 18.3 Implement mock Telnyx sender for testing
...
- [ ] 18.4 Create test data fixtures
