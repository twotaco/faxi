    ...
    <Card>
      ...
      <CardContent>
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-amber-700">{model.accuracy}%</div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {model.techniques.map((technique) => (
                        <span
                          key={technique}
                          className="px-2 py-1 bg-amber-500/10 text-amber-700 text-xs rounded-full border border-amber-500/20"
                        >
                          {technique}
                        </span>
                      ))}
              ...
              <div key={stage.step} className="relative">
                <div className="flex gap-4">
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 rounded-full bg-faxi-brown text-white flex items-center justify-center font-bold text-sm">
                      {stage.step}
                    </div>
                    {idx < processingPipeline.length - 1 && (
                      <div className="w-0.5 h-full bg-amber-200 mt-2" style={{ minHeight: '40px' }} />
                    )}
                  </div>
        ...
        <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-lg">
          <h3 className="font-semibold mb-3 text-amber-700">Overall Performance</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              <div className="text-2xl font-bold text-faxi-brown">90%+</div>
              <div className="text-xs text-stone-600">Overall Accuracy</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-faxi-brown">&lt;5s</div>
              <div className="text-xs text-stone-600">Avg Processing Time</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-faxi-brown">95%+</div>
              <div className="text-xs text-stone-600">Intent Classification</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-faxi-brown">10+</div>
              <div className="text-xs text-stone-600">Supported Use Cases</div>
            </div>
          </div>
        </div>

        {/* Technical Depth Balance */}
        <div className="mt-6 p-4 bg-stone-500/10 border border-stone-500/20 rounded-lg">
          <h3 className="font-semibold mb-2 text-stone-700">For Technical Evaluators</h3>
